...
#include <external\assimp\Importer.hpp> // C++ importer interface
#include <external\assimp\scene.h>      // Output data structure
#include <external\assimp\postprocess.h>// Post processing flags
#include <glm/glm.hpp>
